...
@NgModule({
  ...
  declarations: [AppComponent, WelcomeComponent, NotFoundComponent, RegistrationComponent],
  providers: [AuthService, WelcomeGuardService, LocalStorageService, AuthGuardService],
